...
# BULLET_HIT_SOUND = pygame.mixer.Sound(os.path.join('Asset', 'hit.mp3'))
# BULLET_FIRE_SOUND = pygame.mixer.Sound(os.path.join('Asset', 'fire.mp3'))
...
def draw_window(red, yellow,
                red_bullets, yellow_bullets, red_health, yellow_health):
    WIN.blit(SPACE, (0, 0))
